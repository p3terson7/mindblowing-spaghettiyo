...
Assert-LauncherContains -RelativePath "deploy/bootstrap/Install SAPHIR Shortcut.vbs" -ExpectedText 'shortcut.Arguments = Chr(34) & localLauncherHostPath & Chr(34)'
Assert-LauncherContains -RelativePath "deploy/bootstrap/SAPHIR Launcher Host.vbs" -ExpectedText '/check-update'
