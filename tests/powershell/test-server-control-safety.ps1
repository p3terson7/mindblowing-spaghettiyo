...
$fixtureScriptPath = [System.IO.Path]::GetFullPath((Join-Path -Path $repoRoot -ChildPath "fixture folder/saphir-server.ps1"))
...
try {
    ...
    Set-Content -LiteralPath $invalidPidFile -Value '{"pid":"not-a-number","scriptPath":"/tmp/saphir-server.ps1","processStartedAtUtc":"2026-07-14T00:36:59.3522070Z"}' -Encoding UTF8
