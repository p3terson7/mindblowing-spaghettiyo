...
assert(appShellSource.includes("EmployeesView.js?v=20260917-phase7-validation-v1"), "EmployeesView cache version was not bumped.");
assert(appShellSource.includes("DashboardView.js?v=20260917-phase7-validation-v1"), "DashboardView cache version was not bumped.");
assert(appShellSource.includes("ApprovalsView.js?v=20260917-phase7-validation-v1"), "ApprovalsView cache version was not bumped.");
assert(appShellSource.includes("HistoryView.js?v=20260917-phase7-validation-v1"), "HistoryView cache version was not bumped.");
assert(appShellSource.includes("ProjectsView.js?v=20260917-phase7-validation-v1"), "ProjectsView cache version was not bumped.");
