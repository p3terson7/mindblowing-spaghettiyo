...
assert(indexSource.includes("assets/apple-ui.css?v=20260924-bug-report-minimal-v3"), "The Review attention styles are missing a cache-busting revision.");
assert(indexSource.includes("scripts/I18n.js?v=20260924-bug-report-minimal-v3"), "The Review attention copy is missing a cache-busting revision.");
assert(appShellSource.includes("ApprovalsView.js?v=20260924-bug-report-minimal-v3"), "The lazy Review view is missing a cache-busting revision.");
