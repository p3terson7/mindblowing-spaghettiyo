...
assert(indexSource.includes("assets/apple-ui.css?v=20260921-bug-reports-phase5-v1"), "The project workspace stylesheet cache key was not bumped.");
assert(appShellSource.includes("ProjectsView.js?v=20260921-bug-reports-phase5-v1"), "The lazy project script cache key was not bumped.");
