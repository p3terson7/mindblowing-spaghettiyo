...
assert(indexSource.includes("assets/apple-ui.css?v=20260921-schedule-gc179-fixes-v2"), "The project workspace stylesheet cache key was not bumped.");
assert(appShellSource.includes("ProjectsView.js?v=20260921-schedule-gc179-fixes-v2"), "The lazy project script cache key was not bumped.");
