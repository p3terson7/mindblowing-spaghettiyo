...
assert(indexSource.includes("assets/apple-ui.css?v=20260924-bug-report-minimal-v3"), "The project workspace stylesheet cache key was not bumped.");
assert(appShellSource.includes("ProjectsView.js?v=20260924-bug-report-minimal-v3"), "The lazy project script cache key was not bumped.");
