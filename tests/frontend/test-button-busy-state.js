...
async function main() {
  ...
  for (const asset of [
    "assets/styles.css?v=20260921-bug-reports-phase5-v1",
    "scripts/Utilities.js?v=20260921-bug-reports-phase5-v1",
    "scripts/AppShell.js?v=20260921-bug-reports-phase5-v1",
    "scripts/Views/ViewSwitching.js?v=20260921-bug-reports-phase5-v1",
    "scripts/Views/SelfView.js?v=20260921-bug-reports-phase5-v1",
  ]) {
  ...
  const managerViewCacheVersions = {
    ...
    HistoryView: "20260921-bug-reports-phase5-v1",
