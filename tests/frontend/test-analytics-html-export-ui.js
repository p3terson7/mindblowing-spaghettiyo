...
assert(indexSource.includes("scripts/I18n.js?v=20260917-phase7-validation-v1"), "The localized export UI cache key was not bumped.");
assert(indexSource.includes("scripts/AppShell.js?v=20260917-phase7-validation-v1"), "The application shell cache key was not bumped.");
assert(appShellSource.includes("ProjectsView.js?v=20260917-phase7-validation-v1"), "The project view cache key was not bumped.");
