...
const APP_TRANSLATIONS = {
  en: {
    ...
    "export.gc179DownloadSuccess": "GC179 export downloaded. Extract it, then run GENERER-GC179.cmd on Windows or GENERER-GC179.ps1.",
    "export.gc179ZipDownloadSuccess": "GC179 ZIP downloaded. Extract it, then run GENERER-GC179.cmd on Windows or GENERER-GC179.ps1.",
    "export.gc179DownloadError": "Unable to generate GC179 export: {message}",
  ...
  fr: {
    ...
    "export.gc179DownloadSuccess": "Export GC179 téléchargé. Extrayez-le, puis lancez GENERER-GC179.cmd sur Windows ou GENERER-GC179.ps1.",
    "export.gc179ZipDownloadSuccess": "ZIP GC179 téléchargé. Extrayez-le, puis lancez GENERER-GC179.cmd sur Windows ou GENERER-GC179.ps1.",
    "export.gc179DownloadError": "Impossible de générer l'export GC179 : {message}",
