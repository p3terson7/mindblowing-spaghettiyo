...
const APP_TRANSLATIONS = {
  en: {
    ...
    "employees.seedDemoEntries": "Seed Demo Entries",
    "employees.seedDemoEntriesConfirm": "Generate random demo overtime entries from the active employees and projects on this PC? This appends data to the JSON files and keeps each employee limited to one or two projects.",
    "employees.seedDemoEntriesRunning": "Seeding...",
    "employees.seedDemoEntriesSuccess": "{entries} entries generated for {employees} employees across {projects} projects.",
    "employees.seedDemoEntriesError": "Unable to seed demo entries.",
    "employees.seedDemoEntriesForbidden": "Super admin access is required to seed demo entries.",
    "employees.gc179Import": "Import GC179",
    "employees.gc179ImportTitle": "Import GC179",
    "employees.gc179ImportHint": "Export the opened GC179 as FDF from Acrobat, then import that FDF here.",
  ...
  fr: {
    ...
    "employees.seedDemoEntries": "Générer entrées démo",
    "employees.seedDemoEntriesConfirm": "Générer des entrées d'heures supplémentaires au hasard à partir des employés et projets actifs de ce poste? Les données seront ajoutées aux fichiers JSON et chaque employé restera limité à un ou deux projets.",
    "employees.seedDemoEntriesRunning": "Génération...",
    "employees.seedDemoEntriesSuccess": "{entries} entrées générées pour {employees} employés sur {projects} projets.",
    "employees.seedDemoEntriesError": "Impossible de générer les entrées démo.",
    "employees.seedDemoEntriesForbidden": "L'accès super admin est requis pour générer des entrées démo.",
    "employees.gc179Import": "Importer GC179",
    "employees.gc179ImportTitle": "Importer une GC179",
    "employees.gc179ImportHint": "Exportez la GC179 ouverte en FDF depuis Acrobat, puis importez ce FDF ici.",
