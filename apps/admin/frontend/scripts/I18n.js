...
const APP_TRANSLATIONS = {
  en: {
    ...
    "dashboard.tableManagerNote": "Manager Note",
    ...
    "dashboard.managerMessageRequired": "A manager message is required.",
    ...
    "dashboard.rejectManagerMessagePrompt": "Enter a manager message for this rejection.",
    "dashboard.deleteManagerMessagePrompt": "Enter a manager message before deleting this entry.",
    ...
    "employees.managerNoteLabel": "Manager note",
  ...
  fr: {
    ...
    "dashboard.tableManagerNote": "Note gestionnaire",
    "dashboard.tableActions": "Actions",
    ...
    "dashboard.managerMessageRequired": "Un message gestionnaire est requis.",
    ...
    "dashboard.rejectManagerMessagePrompt": "Entrez un message gestionnaire pour ce rejet.",
    "dashboard.deleteManagerMessagePrompt": "Entrez un message gestionnaire avant de supprimer cette entrée.",
    ...
    "employees.managerNoteLabel": "Note gestionnaire",
