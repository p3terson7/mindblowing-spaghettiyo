...
const APP_TRANSLATIONS = {
  en: {
    ...
    "export.gc179ZipDownloadSuccess": "GC179 ZIP downloaded. Extract it, open the included PDF, then run the GEEM Acrobat batch menu.",
  ...
  fr: {
    ...
    "export.gc179ZipDownloadSuccess": "ZIP GC179 téléchargé. Extrayez-le, ouvrez le PDF inclus, puis lancez le menu batch GÉEM dans Acrobat.",
